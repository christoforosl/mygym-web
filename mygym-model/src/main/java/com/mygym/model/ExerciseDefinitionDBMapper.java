...
@DMLQueries(
	update="update exercise_definition set name=?,video_url=?,description=?,equipment_id=?,create_date=?,update_date=?,create_user=?,update_user=? where exercise_definition_id=?",
	updateRowid="",
	delete="DELETE FROM exercise_definition WHERE exercise_definition_id=?",
	deleteRowid="",
	insert="insert into exercise_definition (name,video_url,description,equipment_id,create_date,update_date,create_user,update_user) values (?,?,?,?,?,?,?,?)",
	selectone="SELECT t.exercise_definition_id, t.name, t.video_url, t.description, t.equipment_id, t.create_date, t.update_date, t.create_user, t.update_user FROM  exercise_definition t  WHERE exercise_definition_id=?",
	selectall="SELECT t.exercise_definition_id, t.name, t.video_url, t.description, t.equipment_id, t.create_date, t.update_date, t.create_user, t.update_user FROM  exercise_definition t ",
	pagingSelect="SELECT t.exercise_definition_id, t.name, t.video_url, t.description, t.equipment_id, t.create_date, t.update_date, t.create_user, t.update_user FROM  exercise_definition t  {criteria} LIMIT {offset}, {pageSize}")
	...
	*/
	...
	public ModelObject load(Object ors) {
		...
		try {
			...
			ret.setCreateDate(readTimeStamp(rs,ExerciseDefinition.FLD_CREATE_DATE));
			ret.setUpdateDate(readTimeStamp(rs,ExerciseDefinition.FLD_UPDATE_DATE));
			ret.setCreateUser(rs.getString(ExerciseDefinition.FLD_CREATE_USER));
			ret.setUpdateUser(rs.getString(ExerciseDefinition.FLD_UPDATE_USER));
...
@Override
	...
	public void fillStatement(ModelObject obj, CallableStatement stmt, boolean bForInsert) throws Exception {
		...
		if (o.getCreateDate()==null){
			...
			stmt.setTimestamp(5, new java.sql.Timestamp( o.getCreateDate().getTime()));
		}
		if (o.getUpdateDate()==null){
			stmt.setNull(6, Types.VARCHAR);
		}else{
			stmt.setTimestamp(6, new java.sql.Timestamp( o.getUpdateDate().getTime()));
		}
		if (o.getCreateUser()==null){
			stmt.setNull(7, Types.VARCHAR);
		}else{
			stmt.setString(7,o.getCreateUser());
		}
		if (o.getUpdateUser()==null){
			stmt.setNull(8, Types.VARCHAR);
		}else{
			stmt.setString(8,o.getUpdateUser());
		}
		...
		if (bForInsert){
		 ...
		 /* For Update statement*/
			stmt.setInt(9,o.getExerciseDefinitionId().intValue());
		}
