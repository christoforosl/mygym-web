...
@DMLQueries(
	update="update body_part_exercise set body_part_id=?,exercise_id=?,create_date=?,update_date=?,create_user=?,update_user=? where body_part_exercise_id=?",
	updateRowid="",
	delete="DELETE FROM body_part_exercise WHERE body_part_exercise_id=?",
	deleteRowid="",
	insert="insert into body_part_exercise (body_part_id,exercise_id,create_date,update_date,create_user,update_user) values (?,?,?,?,?,?)",
	selectone="SELECT t.body_part_exercise_id, t.body_part_id, t.exercise_id, t.create_date, t.update_date, t.create_user, t.update_user FROM  body_part_exercise t  WHERE body_part_exercise_id=?",
	selectall="SELECT t.body_part_exercise_id, t.body_part_id, t.exercise_id, t.create_date, t.update_date, t.create_user, t.update_user FROM  body_part_exercise t ",
	pagingSelect="SELECT t.body_part_exercise_id, t.body_part_id, t.exercise_id, t.create_date, t.update_date, t.create_user, t.update_user FROM  body_part_exercise t  {criteria} LIMIT {offset}, {pageSize}")
	...
	*/
	...
	public ModelObject load(Object ors) {
		...
		try {
			...
			ret.setCreateDate(readTimeStamp(rs,BodyPartExercise.FLD_CREATE_DATE));
			ret.setUpdateDate(readTimeStamp(rs,BodyPartExercise.FLD_UPDATE_DATE));
			ret.setCreateUser(rs.getString(BodyPartExercise.FLD_CREATE_USER));
			ret.setUpdateUser(rs.getString(BodyPartExercise.FLD_UPDATE_USER));
	...
	public void fillStatement(ModelObject obj, CallableStatement stmt, boolean bForInsert) throws Exception {
		...
		if (bForInsert){
		 ...
		 /* For Update statement*/
			stmt.setInt(7,o.getBodyPartExerciseId().intValue());
		}
