 ...
 */
public abstract class JsonModelObject extends OracleModelObject {

	private static final Logger LOGGER = Logger.getLogger(JsonModelObject.class.getName());
