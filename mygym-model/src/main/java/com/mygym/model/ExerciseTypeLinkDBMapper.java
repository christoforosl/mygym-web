...
@DMLQueries(
	update="update exercise_type_link set exercise_type_id=?,exercise_id=?,create_date=?,update_date=?,create_user=?,update_user=? where exercise_type_link_id=?",
	updateRowid="",
	delete="DELETE FROM exercise_type_link WHERE exercise_type_link_id=?",
	deleteRowid="",
	insert="insert into exercise_type_link (exercise_type_id,exercise_id,create_date,update_date,create_user,update_user) values (?,?,?,?,?,?)",
	selectone="SELECT t.exercise_type_link_id, t.exercise_type_id, t.exercise_id, t.create_date, t.update_date, t.create_user, t.update_user FROM  exercise_type_link t  WHERE exercise_type_link_id=?",
	selectall="SELECT t.exercise_type_link_id, t.exercise_type_id, t.exercise_id, t.create_date, t.update_date, t.create_user, t.update_user FROM  exercise_type_link t ",
	pagingSelect="SELECT t.exercise_type_link_id, t.exercise_type_id, t.exercise_id, t.create_date, t.update_date, t.create_user, t.update_user FROM  exercise_type_link t  {criteria} LIMIT {offset}, {pageSize}")
	...
	*/
	...
	public ModelObject load(Object ors) {
		...
		try {
			...
			ret.setCreateDate(readTimeStamp(rs,ExerciseTypeLink.FLD_CREATE_DATE));
			ret.setUpdateDate(readTimeStamp(rs,ExerciseTypeLink.FLD_UPDATE_DATE));
			ret.setCreateUser(rs.getString(ExerciseTypeLink.FLD_CREATE_USER));
			ret.setUpdateUser(rs.getString(ExerciseTypeLink.FLD_UPDATE_USER));
	...
	public void fillStatement(ModelObject obj, CallableStatement stmt, boolean bForInsert) throws Exception {
		...
		if (bForInsert){
		 ...
		 /* For Update statement*/
			stmt.setInt(7,o.getExerciseTypeLinkId().intValue());
		}
